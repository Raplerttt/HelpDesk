...
const SignUp = () => {
    ...
    <div className="flex flex-col items-center">
      <p className="text-orange-400 text-3xl font-bold">Pusat</p> {/* Tanpa margin bawah */}
      <p className="text-blue-700 text-3xl font-bold -mt-11">Bantuan</p> {/* Tanpa margin atas */}
    </div>
      </div>
